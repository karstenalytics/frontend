...
Please note that below you will find a high-level overview, further details about how the [data pipeline](/analysis/data-pipeline) works, and specifics about the projects I cover, can be found in the [Analysis](/analysis/overview) section.
...
The project follows a linear pipeline from blockchain to browser (for a detailed technical breakdown, see [Data Pipeline](/analysis/data-pipeline)):
