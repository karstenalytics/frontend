...
See the [revenue attribution system](/analysis/data-pipeline#token-normalization) for details on how SwapReward conversions attribute back to original transaction types.
