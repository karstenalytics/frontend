      ...
      return (
        <div className="usage-summary-grid">
          ...
          <MetricCard
            ...
            tooltip={`(Staked + held) / unlocked-from-vesting across all vesting wallets.\nMeasures how much of the vested (no longer locked) TUNA recipients still retain.\n>100% means wallets acquired extra TUNA beyond their vested amount.\nChange vs. 7 days ago in percentage points.`}
          />
        </div>
      );
    }
...
- **Vesting Wallet Conviction**: Ratio of (staked + held) to unlocked TUNA across all vesting wallets. Values above 100% indicate wallets acquired additional TUNA beyond their unlocked vesting amount
