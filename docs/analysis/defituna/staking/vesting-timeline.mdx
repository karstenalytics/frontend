      ...
      return (
        <>
          ...
          <UnlockTimelineChart
            ...
            stakedTimeline={staked_by_vesting_wallets_timeline || {}}
...
- **[Stakers](/analysis/defituna/usage-statistics/active-stakers)**: Tracks wallets executing staking instructions
