...
<ChartPageSEO
  ...
  description="Individual wallet staking history and balance evolution"
  chartType="line"
/>
      ...
      return (
        <div style={{ padding: '0' }}>
          ...
          <div style={{
            ...
            <label htmlFor="tuna-wallet-address" style={{
              display: 'block',
              marginBottom: '12px',
              fontWeight: 600,
              fontSize: '14px',
            ...
            <p style={{
              ...
              Enter any wallet address from the staking cache. No idea which address to enter? Check <a href="/analysis/defituna/staking/staked-tuna" style={{ color: 'var(--accent)', textDecoration: 'none' }}>recent stakers/withdrawers</a> or <a href="https://defituna.com/stake" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--accent)', textDecoration: 'none' }}>DefiTuna Leaderboard</a> or use the notable wallets below.
            </p>
          ...
          {error && !loading && (
            <div style={{
              ...
              <p style={{ fontSize: '14px', color: 'var(--ifm-color-secondary)', marginTop: '16px', marginBottom: 0 }}>
                Please check the wallet address and try again. The wallet must exist in the staking cache.
              </p>
            </div>
          )}
          ...
          {data && data.found && !loading && (
            <>
              ...
              <WalletTimelineChart data={data} zoomRange={zoomRange} onZoomChange={(range) => { setZoomRange(range); setCurrentPage(0); }} />
          ...
          {data && !data.found && !loading && !error && (
            <div style={{
              ...
              <p style={{ fontSize: '14px', color: 'var(--ifm-color-secondary)' }}>
                The wallet must be present in the current staking cache to appear here.
              </p>
            </div>
          )}
        </div>
...
- **[Stakers](/analysis/defituna/adoption/active-stakers)**: Shows all active stakers ranked by activity
