...
<ChartPageSEO
  title="TUNA Staking APR"
  description="Rolling 7-day, 30-day, and all-time staking APR"
  chartType="line"
/>
...
1. Review the current 7d, 30d, and all-time APR cards
2. Enter your TUNA purchase price below the chart to enable Entry Price APR
3. Use the Reference / Entry Price toggle above the cards to switch the card values
4. Use the 7d / 30d chart toggle to inspect short-term vs. smoother APR history
