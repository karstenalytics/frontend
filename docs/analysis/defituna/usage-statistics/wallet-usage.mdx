      ...
      return (
        <>
          ...
          <div style={{ marginTop: '48px' }}>
            <h2 id="top-daily-wallets">Top Daily Wallets</h2>
            <p style={{ marginBottom: '16px' }}>
              Wallets ranked by the number of distinct days they executed fee-generating transactions.
              This metric identifies the most consistently active wallets across the entire measurement period.
            </p>
            <UsageTopAddresses
              title=""
...
**Excluded activities:**
- Staking/unstaking operations (tracked separately in [Stakers](/analysis/defituna/usage-statistics/active-stakers))
- Failed transactions
