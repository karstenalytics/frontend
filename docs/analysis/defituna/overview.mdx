...
- Where does DefiTuna's revenue come from? -> [By Pool](./fees-revenue/by-pool), [By Type](./fees-revenue/tx-type-per-day)
- What are the biggest drivers of DefiTuna's protocol revenue? → [Pools vs. Types](./fees-revenue/pools-vs-types)
- Why is the protocol revenue on certain days higher than on other days? → [Types per Day](./fees-revenue/tx-type-per-day)
