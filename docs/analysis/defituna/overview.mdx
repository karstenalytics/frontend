...
<BrowserOnly fallback={<LoadingSpinner />}>
  {() => {
    ...
    const TokenDisplay = require('@site/src/components/common/TokenDisplay').default;
    ...
    function KeyMetricsDisplay() {
      ...
      useEffect(() => {
        fetch('/data/defituna/key_metrics.json')
          .then(res => res.json())
          .then(data => {
            setData(data);
            setLoading(false);
      ...
      return (
        <div className="usage-summary-grid">
          <div className="usage-summary-card">
            ...
            <p>
              {revenue_30d?.sol?.toLocaleString(undefined, { maximumFractionDigits: 0 }) || '—'}
              {' '}
              <TokenDisplay mint="SOL" size={16} />
            </p>
          ...
          <div className="usage-summary-card">
            ...
            <p>
              {revenue_30d?.annualized_sol?.toLocaleString(undefined, { maximumFractionDigits: 0 }) || '—'}
              {' '}
              <TokenDisplay mint="SOL" size={16} />
            </p>
            <div style={{ fontSize: '0.9rem', color: 'var(--ifm-color-emphasis-600)', marginTop: '4px' }}>
          ...
          <div className="usage-summary-card">
            ...
            <div style={{ fontSize: '0.9rem', color: 'var(--ifm-color-emphasis-600)', marginTop: '4px' }}>
              ${market_data?.tuna_price_usd?.toFixed(4) || '—'} per{' '}
              <TokenDisplay mint="TUNAfXDZEdQizTMTh3uEvNvYqJmqFHZbEJt8joP4cyx" size={14} symbol="TUNA" />
            </div>
          </div>
          ...
          <div className="usage-summary-card">
            ...
            <div style={{ fontSize: '0.9rem', color: 'var(--ifm-color-emphasis-600)', marginTop: '4px' }}>
              {(metrics?.total_staked_tuna || 0) >= 1_000_000
                ? `${((metrics?.total_staked_tuna || 0) / 1_000_000).toFixed(0)}M `
