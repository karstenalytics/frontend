...
- **[By Pool](/analysis/flash-trade/fees-revenue/by-pool)**: Aggregates all types to show total pool performance (horizontal sum of Marimekko)
- **[By Type](/analysis/flash-trade/fees-revenue/by-type)**: Aggregates all pools to show total type performance (vertical sum of Marimekko)
...
- Classification to canonical operation names (category labels such as Opening/Closing/Trigger/System are conceptual only and not a separate chart dimension on this page)
